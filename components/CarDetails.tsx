            ...
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" className="relative z-10"
                    ...
                    <Transition.Child
                        ...
                        leaveTo='opacity-0'
                    >
                        <div className="fixed insset-0 bg-black
                    bg-opacity-25" />
                    </Transition.Child>
                    ...
                    justify-center p-4 text-center">
                            ...
                            >
                                ...
                                max-h-[90vh] overflow-y-auto transform rounded-2xl p-6
                                bg-white text-left shadow-xsl transition-all flex flex-col gap-5">
                                    ...
                                    <div className='flex-1 flex flex-col gap-3'>
                                        ...
                                        <div className='flex gap-3'>
                                            ...
                                            w-full h-24 bg-primary-blue-100 rounded-lg'>
                                                <Image
                                                    src={generateCarImageUrl(car, '29')} alt="car model"
                                                    fill priority
                                                    className='object-contain'
                                            ...
                                            w-full h-24 bg-primary-blue-100 rounded-lg'>
                                                <Image
                                                    src={generateCarImageUrl(car, '33')} alt="car model"
                                                    fill priority
                                                    className='object-contain'
                                            ...
                                            w-full h-24 bg-primary-blue-100 rounded-lg'>
                                                <Image
                                                    src={generateCarImageUrl(car, '13')} alt="car model"
                                                    fill priority
                                                    className='object-contain'
